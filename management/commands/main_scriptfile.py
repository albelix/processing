...
# from processing.main import Location
...
class Command(BaseCommand):
    def run(self, *argv, **options):
        ...
        getpartcode=dfsubj['participant.code'][0] # get label (code) of the current participant for merger
